            ...
            if handle.conf_get('cosched.allowed') == True:
                ...
                for parent, resource, count in jobspec.resource_walk():
                    if parent and parent['type'] != 'slot':
                        raise ValueError("Can only co-schedule user requests with only resources of the lowest hierarchy specified")
                ...
                resource_type = handle.conf_get('cosched.resource_type')
